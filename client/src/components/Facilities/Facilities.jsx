...
import { Box, Group, NumberInput, Button } from "@mantine/core";
...
const Facilities = ({
  ...
  const { mutate, isLoading } = useMutation({
    ...
    onSettled: () => {
      toast.success("Add Successfully", { position: "bottom-right" });
      setPropertyDetails({
        title: "",
        description: "",
        price: 0,
      ...
      setOpened(false);
      setActiveStep(0);
      if (typeof refetchProperties === "function") {
        refetchProperties();
      } else {
        console.error("refetchProperties is not a function", refetchProperties);
      }
    },
  });
  return (
